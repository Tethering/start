damnation_arrow_lua = class({})
LinkLuaModifier( "modifier_damnation_arrow_effect_lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_damnation_arrow_stun_lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------

function damnation_arrow_lua:OnSpellStart()
	print ("OnSpellStart")
...
function damnation_arrow_lua:OnProjectileHit( hTarget, vLocation )
	...
	if hTarget ~= nil and ( not hTarget:IsMagicImmune() ) and ( not hTarget:IsInvulnerable() ) then
		...
		hTarget:AddNewModifier( self:GetCaster(), self, "modifier_damnation_arrow_effect_lua", { duration = self.damnation_duration } )
